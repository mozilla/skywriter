require.def(['require', 'exports', 'module',
    ...
    'text_editor/views/views/scroller',
    'skywriter/util/util',
    'text_editor/views/models/buffer',
    'completion/controller',
    'text_editor/views/controllers/search',
    'text_editor/views/controllers/undo',
    'text_editor/views/events',
    'text_editor/views/views/gutter',
    'text_editor/views/controllers/layoutmanager',
    'text_editor/views/views/text',
    'text_editor/views/underscore',
    'skywriter/plugins',
    'keyboard/keyboard',
